...
#define qemu_log(...)
#define qemu_loglevel_mask(...) 0

/*****************************************************************************/
/* Exceptions processing helpers */

void HELPER(raise_exception_err )(uint32_t exception, int error_code)
{
#if 1
    if (exception < 0x100)
...
void HELPER(raise_exception )(uint32_t exception)
{
    HELPER(raise_exception_err)(exception, 0);
}

void HELPER(interrupt_restart )(void)
{
    if (!(env->CP0_Status & (1 << CP0St_EXL)) &&
        ...
        HELPER(raise_exception)(EXCP_EXT_INTERRUPT);
    }
}
...
target_ulong HELPER(clo )(target_ulong t0)
{
    return clo32(t0);
}

target_ulong HELPER(clz )(target_ulong t0)
{
    return clz32(t0);
}

#if defined(TARGET_MIPS64)
target_ulong HELPER(dclo )(target_ulong t0)
{
    return clo64(t0);
}

target_ulong HELPER(dclz )(target_ulong t0)
{
    return clz64(t0);
}
#endif /* TARGET_MIPS64 */
...
void HELPER(madd )(target_ulong t0, target_ulong t1)
{
    int64_t tmp;
...
void HELPER(maddu )(target_ulong t0, target_ulong t1)
{
    uint64_t tmp;
...
void HELPER(msub )(target_ulong t0, target_ulong t1)
{
    int64_t tmp;
...
void HELPER(msubu )(target_ulong t0, target_ulong t1)
{
    uint64_t tmp;
...
target_ulong HELPER(muls )(target_ulong t0, target_ulong t1)
{
...
target_ulong HELPER(mulsu )(target_ulong t0, target_ulong t1)
{
...
target_ulong HELPER(macc )(target_ulong t0, target_ulong t1)
{
...
target_ulong HELPER(macchi )(target_ulong t0, target_ulong t1)
{
...
target_ulong HELPER(maccu )(target_ulong t0, target_ulong t1)
{
...
target_ulong HELPER(macchiu )(target_ulong t0, target_ulong t1)
{
...
target_ulong HELPER(msac )(target_ulong t0, target_ulong t1)
{
    set_HI_LOT0(t0, ((int64_t)get_HILO()) - ((int64_t)(int32_t)t0 * (int64_t)(int32_t)t1));
...
target_ulong HELPER(msachi )(target_ulong t0, target_ulong t1)
{
    set_HIT0_LO(t0, ((int64_t)get_HILO()) - ((int64_t)(int32_t)t0 * (int64_t)(int32_t)t1));
...
target_ulong HELPER(msacu )(target_ulong t0, target_ulong t1)
{
    set_HI_LOT0(t0, ((uint64_t)get_HILO()) - ((uint64_t)(uint32_t)t0 * (uint64_t)(uint32_t)t1));
...
target_ulong HELPER(msachiu )(target_ulong t0, target_ulong t1)
{
    set_HIT0_LO(t0, ((uint64_t)get_HILO()) - ((uint64_t)(uint32_t)t0 * (uint64_t)(uint32_t)t1));
...
target_ulong HELPER(mulhi )(target_ulong t0, target_ulong t1)
{
...
target_ulong HELPER(mulhiu )(target_ulong t0, target_ulong t1)
{
...
target_ulong HELPER(mulshi )(target_ulong t0, target_ulong t1)
{
...
target_ulong HELPER(mulshiu )(target_ulong t0, target_ulong t1)
{
...
#ifdef TARGET_MIPS64
void HELPER(dmult )(target_ulong t0, target_ulong t1)
{
    muls64(&(env->active_tc.LO[0]), &(env->active_tc.HI[0]), t0, t1);
}

void HELPER(dmultu )(target_ulong t0, target_ulong t1)
{
...
target_ulong HELPER(lwl)(target_ulong t0, target_ulong t1, int mem_idx)
{
    target_ulong tmp;
...
target_ulong HELPER(lwr)(target_ulong t0, target_ulong t1, int mem_idx)
{
    target_ulong tmp;
...
void HELPER(swl)(target_ulong t0, target_ulong t1, int mem_idx)
{
#ifdef CONFIG_USER_ONLY
...
void HELPER(swr)(target_ulong t0, target_ulong t1, int mem_idx)
{
#ifdef CONFIG_USER_ONLY
#define stfun stb_raw
#else
...
target_ulong HELPER(ldl)(target_ulong t0, target_ulong t1, int mem_idx)
{
    uint64_t tmp;
...
target_ulong HELPER(ldr)(target_ulong t0, target_ulong t1, int mem_idx)
{
    uint64_t tmp;
...
void HELPER(sdl)(target_ulong t0, target_ulong t1, int mem_idx)
{
#ifdef CONFIG_USER_ONLY
#define stfun stb_raw
#else
...
void HELPER(sdr)(target_ulong t0, target_ulong t1, int mem_idx)
{
#ifdef CONFIG_USER_ONLY
#define stfun stb_raw
#else
...
/* CP0 helpers */
target_ulong HELPER(mfc0_mvpcontrol )(void)
{
    return env->mvp->CP0_MVPControl;
}

target_ulong HELPER(mfc0_mvpconf0 )(void)
{
    return env->mvp->CP0_MVPConf0;
}

target_ulong HELPER(mfc0_mvpconf1 )(void)
{
    return env->mvp->CP0_MVPConf1;
}

target_ulong HELPER(mfc0_random )(void)
{
    return (int32_t)cpu_mips_get_random(env);
}

target_ulong HELPER(mfc0_tcstatus )(void)
{
    return env->active_tc.CP0_TCStatus;
}

target_ulong HELPER(mftc0_tcstatus)(void)
{
...
target_ulong HELPER(mfc0_tcbind )(void)
{
    return env->active_tc.CP0_TCBind;
}

target_ulong HELPER(mftc0_tcbind)(void)
{
    int other_tc = env->CP0_VPEControl & (0xff << CP0VPECo_TargTC);
...
target_ulong HELPER(mfc0_tcrestart )(void)
{
    return env->active_tc.PC;
}

target_ulong HELPER(mftc0_tcrestart)(void)
{
    int other_tc = env->CP0_VPEControl & (0xff << CP0VPECo_TargTC);
...
target_ulong HELPER(mfc0_tchalt )(void)
{
    return env->active_tc.CP0_TCHalt;
}

target_ulong HELPER(mftc0_tchalt)(void)
{
    int other_tc = env->CP0_VPEControl & (0xff << CP0VPECo_TargTC);
...
target_ulong HELPER(mfc0_tccontext )(void)
{
    return env->active_tc.CP0_TCContext;
}

target_ulong HELPER(mftc0_tccontext)(void)
{
    int other_tc = env->CP0_VPEControl & (0xff << CP0VPECo_TargTC);
...
target_ulong HELPER(mfc0_tcschedule )(void)
{
    return env->active_tc.CP0_TCSchedule;
}

target_ulong HELPER(mftc0_tcschedule)(void)
{
    int other_tc = env->CP0_VPEControl & (0xff << CP0VPECo_TargTC);
...
target_ulong HELPER(mfc0_tcschefback )(void)
{
    return env->active_tc.CP0_TCScheFBack;
}

target_ulong HELPER(mftc0_tcschefback)(void)
{
    int other_tc = env->CP0_VPEControl & (0xff << CP0VPECo_TargTC);
...
target_ulong HELPER(mfc0_count )(void)
{
    return (int32_t)cpu_mips_get_count(env);
}

target_ulong HELPER(mftc0_entryhi)(void)
{
    int other_tc = env->CP0_VPEControl & (0xff << CP0VPECo_TargTC);
    int32_t tcstatus;
...
target_ulong HELPER(mftc0_status)(void)
{
    int other_tc = env->CP0_VPEControl & (0xff << CP0VPECo_TargTC);
    target_ulong t0;
    int32_t tcstatus;
...
target_ulong HELPER(mfc0_lladdr )(void)
{
    return (int32_t)env->CP0_LLAddr >> 4;
}

target_ulong HELPER(mfc0_watchlo )(uint32_t sel)
{
    return (int32_t)env->CP0_WatchLo[sel];
}

target_ulong HELPER(mfc0_watchhi )(uint32_t sel)
{
    return env->CP0_WatchHi[sel];
}

target_ulong HELPER(mfc0_debug )(void)
{
...
target_ulong HELPER(mftc0_debug)(void)
{
    int other_tc = env->CP0_VPEControl & (0xff << CP0VPECo_TargTC);
    int32_t tcstatus;
...
#if defined(TARGET_MIPS64)
target_ulong HELPER(dmfc0_tcrestart )(void)
{
    return env->active_tc.PC;
}

target_ulong HELPER(dmfc0_tchalt )(void)
{
    return env->active_tc.CP0_TCHalt;
}

target_ulong HELPER(dmfc0_tccontext )(void)
{
    return env->active_tc.CP0_TCContext;
}

target_ulong HELPER(dmfc0_tcschedule )(void)
{
    return env->active_tc.CP0_TCSchedule;
}

target_ulong HELPER(dmfc0_tcschefback )(void)
{
    return env->active_tc.CP0_TCScheFBack;
}

target_ulong HELPER(dmfc0_lladdr )(void)
{
    return env->CP0_LLAddr >> 4;
}

target_ulong HELPER(dmfc0_watchlo )(uint32_t sel)
{
    return env->CP0_WatchLo[sel];
}
#endif /* TARGET_MIPS64 */

void HELPER(mtc0_index )(target_ulong t0)
{
    int num = 1;
...
void HELPER(mtc0_mvpcontrol )(target_ulong t0)
{
    uint32_t mask = 0;
    uint32_t newval;
...
void HELPER(mtc0_vpecontrol )(target_ulong t0)
{
    uint32_t mask;
    uint32_t newval;
...
void HELPER(mtc0_vpeconf0 )(target_ulong t0)
{
    uint32_t mask = 0;
    uint32_t newval;
...
void HELPER(mtc0_vpeconf1 )(target_ulong t0)
{
    uint32_t mask = 0;
    uint32_t newval;
...
void HELPER(mtc0_yqmask )(target_ulong t0)
{
    /* Yield qualifier inputs not implemented. */
    env->CP0_YQMask = 0x00000000;
}

void HELPER(mtc0_vpeopt )(target_ulong t0)
{
    env->CP0_VPEOpt = t0 & 0x0000ffff;
}

void HELPER(mtc0_entrylo0 )(target_ulong t0)
{
...
void HELPER(mtc0_tcstatus )(target_ulong t0)
{
...
void HELPER(mttc0_tcstatus )(target_ulong t0)
{
    int other_tc = env->CP0_VPEControl & (0xff << CP0VPECo_TargTC);
...
void HELPER(mtc0_tcbind )(target_ulong t0)
{
...
void HELPER(mttc0_tcbind )(target_ulong t0)
{
    int other_tc = env->CP0_VPEControl & (0xff << CP0VPECo_TargTC);
    uint32_t mask = (1 << CP0TCBd_TBE);
    uint32_t newval;
...
void HELPER(mtc0_tcrestart )(target_ulong t0)
{
    env->active_tc.PC = t0;
...
void HELPER(mttc0_tcrestart )(target_ulong t0)
{
    int other_tc = env->CP0_VPEControl & (0xff << CP0VPECo_TargTC);
...
void HELPER(mtc0_tchalt )(target_ulong t0)
{
...
void HELPER(mttc0_tchalt )(target_ulong t0)
{
    int other_tc = env->CP0_VPEControl & (0xff << CP0VPECo_TargTC);
...
void HELPER(mtc0_tccontext )(target_ulong t0)
{
    env->active_tc.CP0_TCContext = t0;
}

void HELPER(mttc0_tccontext )(target_ulong t0)
{
    int other_tc = env->CP0_VPEControl & (0xff << CP0VPECo_TargTC);
...
void HELPER(mtc0_tcschedule )(target_ulong t0)
{
    env->active_tc.CP0_TCSchedule = t0;
}

void HELPER(mttc0_tcschedule )(target_ulong t0)
{
    int other_tc = env->CP0_VPEControl & (0xff << CP0VPECo_TargTC);
...
void HELPER(mtc0_tcschefback )(target_ulong t0)
{
    env->active_tc.CP0_TCScheFBack = t0;
}

void HELPER(mttc0_tcschefback )(target_ulong t0)
{
    int other_tc = env->CP0_VPEControl & (0xff << CP0VPECo_TargTC);
...
void HELPER(mtc0_entrylo1 )(target_ulong t0)
{
    /* Large physaddr (PABITS) not implemented */
    /* 1k pages not implemented */
...
void HELPER(mtc0_context )(target_ulong t0)
{
    env->CP0_Context = (env->CP0_Context & 0x007FFFFF) | (t0 & ~0x007FFFFF);
}

void HELPER(mtc0_pagemask )(target_ulong t0)
{
    /* 1k pages not implemented */
    env->CP0_PageMask = t0 & (0x1FFFFFFF & (TARGET_PAGE_MASK << 1));
}

void HELPER(mtc0_pagegrain )(target_ulong t0)
{
...
void HELPER(mtc0_wired )(target_ulong t0)
{
    env->CP0_Wired = t0 % env->tlb->nb_tlb;
}

void HELPER(mtc0_srsconf0 )(target_ulong t0)
{
    env->CP0_SRSConf0 |= t0 & env->CP0_SRSConf0_rw_bitmask;
}

void HELPER(mtc0_srsconf1 )(target_ulong t0)
{
    env->CP0_SRSConf1 |= t0 & env->CP0_SRSConf1_rw_bitmask;
}

void HELPER(mtc0_srsconf2 )(target_ulong t0)
{
    env->CP0_SRSConf2 |= t0 & env->CP0_SRSConf2_rw_bitmask;
}

void HELPER(mtc0_srsconf3 )(target_ulong t0)
{
    env->CP0_SRSConf3 |= t0 & env->CP0_SRSConf3_rw_bitmask;
}

void HELPER(mtc0_srsconf4 )(target_ulong t0)
{
    env->CP0_SRSConf4 |= t0 & env->CP0_SRSConf4_rw_bitmask;
}

void HELPER(mtc0_hwrena )(target_ulong t0)
{
    env->CP0_HWREna = t0 & 0x0000000F;
}

void HELPER(mtc0_count )(target_ulong t0)
{
    cpu_mips_store_count(env, t0);
}

void HELPER(mtc0_entryhi )(target_ulong t0)
{
...
void HELPER(mttc0_entryhi)(target_ulong t0)
{
    int other_tc = env->CP0_VPEControl & (0xff << CP0VPECo_TargTC);
    int32_t tcstatus;
...
void HELPER(mtc0_compare )(target_ulong t0)
{
    cpu_mips_store_compare(env, t0);
}

void HELPER(mtc0_status )(target_ulong t0)
{
    uint32_t val, old;
...
void HELPER(mttc0_status)(target_ulong t0)
{
    int other_tc = env->CP0_VPEControl & (0xff << CP0VPECo_TargTC);
...
void HELPER(mtc0_intctl )(target_ulong t0)
{
    /* vectored interrupts not implemented, no performance counters. */
    env->CP0_IntCtl = (env->CP0_IntCtl & ~0x000002e0) | (t0 & 0x000002e0);
}

void HELPER(mtc0_srsctl )(target_ulong t0)
{
    uint32_t mask = (0xf << CP0SRSCtl_ESS) | (0xf << CP0SRSCtl_PSS);
    env->CP0_SRSCtl = (env->CP0_SRSCtl & ~mask) | (t0 & mask);
}

void HELPER(mtc0_cause )(target_ulong t0)
{
...
void HELPER(mtc0_ebase )(target_ulong t0)
{
...
void HELPER(mtc0_config0 )(target_ulong t0)
{
    env->CP0_Config0 = (env->CP0_Config0 & 0x81FFFFF8) | (t0 & 0x00000007);
}

void HELPER(mtc0_config2 )(target_ulong t0)
{
    /* tertiary/secondary caches not implemented */
    env->CP0_Config2 = (env->CP0_Config2 & 0x8FFF0FFF);
}

void HELPER(mtc0_watchlo )(target_ulong t0, uint32_t sel)
{
...
void HELPER(mtc0_watchhi )(target_ulong t0, uint32_t sel)
{
    env->CP0_WatchHi[sel] = (t0 & 0x40FF0FF8);
    env->CP0_WatchHi[sel] &= ~(env->CP0_WatchHi[sel] & t0 & 0x7);
}

void HELPER(mtc0_xcontext )(target_ulong t0)
{
    target_ulong mask = (1ULL << (env->SEGBITS - 7)) - 1;
    env->CP0_XContext = (env->CP0_XContext & mask) | (t0 & ~mask);
}

void HELPER(mtc0_framemask )(target_ulong t0)
{
    env->CP0_Framemask = t0; /* XXX */
}

void HELPER(mtc0_debug )(target_ulong t0)
{
...
void HELPER(mttc0_debug)(target_ulong t0)
{
    int other_tc = env->CP0_VPEControl & (0xff << CP0VPECo_TargTC);
...
void HELPER(mtc0_performance0 )(target_ulong t0)
{
    env->CP0_Performance0 = t0 & 0x000007ff;
}

void HELPER(mtc0_taglo )(target_ulong t0)
{
    env->CP0_TagLo = t0 & 0xFFFFFCF6;
}

void HELPER(mtc0_datalo )(target_ulong t0)
{
    env->CP0_DataLo = t0; /* XXX */
}

void HELPER(mtc0_taghi )(target_ulong t0)
{
    env->CP0_TagHi = t0; /* XXX */
}

void HELPER(mtc0_datahi )(target_ulong t0)
{
...
void HELPER(mtc0_status_irqraise_debug)(void)
{
    qemu_log("Raise pending IRQs\n");
}

/* MIPS MT functions */
target_ulong HELPER(mftgpr)(uint32_t sel)
{
    int other_tc = env->CP0_VPEControl & (0xff << CP0VPECo_TargTC);
...
target_ulong HELPER(mftlo)(uint32_t sel)
{
    int other_tc = env->CP0_VPEControl & (0xff << CP0VPECo_TargTC);
...
target_ulong HELPER(mfthi)(uint32_t sel)
{
    int other_tc = env->CP0_VPEControl & (0xff << CP0VPECo_TargTC);
...
target_ulong HELPER(mftacx)(uint32_t sel)
{
    int other_tc = env->CP0_VPEControl & (0xff << CP0VPECo_TargTC);
...
target_ulong HELPER(mftdsp)(void)
{
    int other_tc = env->CP0_VPEControl & (0xff << CP0VPECo_TargTC);
...
void HELPER(mttgpr)(target_ulong t0, uint32_t sel)
{
    int other_tc = env->CP0_VPEControl & (0xff << CP0VPECo_TargTC);
...
void HELPER(mttlo)(target_ulong t0, uint32_t sel)
{
    int other_tc = env->CP0_VPEControl & (0xff << CP0VPECo_TargTC);
...
void HELPER(mtthi)(target_ulong t0, uint32_t sel)
{
    int other_tc = env->CP0_VPEControl & (0xff << CP0VPECo_TargTC);
...
void HELPER(mttacx)(target_ulong t0, uint32_t sel)
{
    int other_tc = env->CP0_VPEControl & (0xff << CP0VPECo_TargTC);
...
void HELPER(mttdsp)(target_ulong t0)
{
    int other_tc = env->CP0_VPEControl & (0xff << CP0VPECo_TargTC);
...
/* MIPS MT functions */
target_ulong HELPER(dmt)(target_ulong t0)
{
    // TODO
    t0 = 0;
    // rt = t0
...
target_ulong HELPER(emt)(target_ulong t0)
{
    // TODO
    t0 = 0;
    // rt = t0
...
target_ulong HELPER(dvpe)(target_ulong t0)
{
    // TODO
    t0 = 0;
    // rt = t0
...
target_ulong HELPER(evpe)(target_ulong t0)
{
    // TODO
    t0 = 0;
    // rt = t0
...
void HELPER(fork)(target_ulong t0, target_ulong t1)
{
    // t0 = rt, t1 = rs
    t0 = 0;
...
target_ulong HELPER(yield)(target_ulong t0)
{
    if (t0 < 0) {
        ...
        if (t0 != -2) {
            if (env->CP0_VPEControl & (1 << CP0VPECo_YSI) &&
                ...
                HELPER(raise_exception)(EXCP_THREAD);
            }
        }
    } else if (t0 == 0) {
...
void HELPER(tlbwi)(void)
{
    env->tlb->do_tlbwi();
}

void HELPER(tlbwr)(void)
{
    env->tlb->do_tlbwr();
}

void HELPER(tlbp)(void)
{
    env->tlb->do_tlbp();
}
...
target_ulong HELPER(rdhwr_cpunum)(void)
{
    if ((env->hflags & MIPS_HFLAG_CP0) ||
        (env->CP0_HWREna & (1 << 0)))
        return env->CP0_EBase & 0x3ff;
    else
        HELPER(raise_exception)(EXCP_RI);

    return 0;
}

target_ulong HELPER(rdhwr_synci_step)(void)
{
    if ((env->hflags & MIPS_HFLAG_CP0) ||
        (env->CP0_HWREna & (1 << 1)))
...
target_ulong HELPER(rdhwr_cc)(void)
{
    if ((env->hflags & MIPS_HFLAG_CP0) ||
        (env->CP0_HWREna & (1 << 2)))
...
target_ulong HELPER(rdhwr_ccres)(void)
{
    if ((env->hflags & MIPS_HFLAG_CP0) ||
        (env->CP0_HWREna & (1 << 3)))
        return env->CCRes;
...
void HELPER(wait )(void)
{
    env->halted = 1;
    HELPER(raise_exception)(EXCP_HLT);
}

#if !defined(CONFIG_USER_ONLY)

static void HELPER(unaligned_access )(target_ulong addr, int is_write, int is_user, void *retaddr);
...
void do_unaligned_access (target_ulong addr, int is_write, int is_user, void *retaddr)
{
    ...
    HELPER(raise_exception) (is_write == 1 ? EXCP_AdES : EXCP_AdEL);
}
...
void tlb_fill (target_ulong addr, int is_write, int mmu_idx, void *retaddr)
{
    ...
    if (ret) {
        ...
        HELPER(raise_exception_err)(env->exception_index, env->error_code);
    }
    env = saved_env;
}
...
void do_unassigned_access(target_phys_addr_t addr, int is_write, int is_exec,
                          int unused, int size)
{
    printf("HELPER(unassigned_access)(%p, %d, %d, %d, %d)\n",
            addr, is_write, is_exec, unused, size);
    if (is_exec)
        HELPER(raise_exception)(EXCP_IBE);
    else
        HELPER(raise_exception)(EXCP_DBE);
}
...
target_ulong HELPER(cfc1 )(uint32_t reg)
{
    target_ulong t0;
...
void HELPER(ctc1 )(target_ulong t0, uint32_t reg)
{
    switch(reg) {
    case 25:
        if (t0 & 0xffffff00)
    ...
    if ((GET_FP_ENABLE(env->active_fpu.fcr31) | 0x20) & GET_FP_CAUSE(env->active_fpu.fcr31))
        HELPER(raise_exception)(EXCP_FPE);
}
...
uint64_t HELPER(float_sqrt_d)(uint64_t fdt0)
{
    return float64_sqrt(fdt0, &env->active_fpu.fp_status);
}

uint32_t HELPER(float_sqrt_s)(uint32_t fst0)
{
    return float32_sqrt(fst0, &env->active_fpu.fp_status);
}

uint64_t HELPER(float_cvtd_s)(uint32_t fst0)
{
    uint64_t fdt2;
...
uint64_t HELPER(float_cvtd_w)(uint32_t wt0)
{
    uint64_t fdt2;
...
uint64_t HELPER(float_cvtd_l)(uint64_t dt0)
{
    uint64_t fdt2;
...
uint64_t HELPER(float_cvtl_d)(uint64_t fdt0)
{
    uint64_t dt2;
...
uint64_t HELPER(float_cvtl_s)(uint32_t fst0)
{
    uint64_t dt2;
...
uint64_t HELPER(float_cvtps_pw)(uint64_t dt0)
{
    uint32_t fst2;
    uint32_t fsth2;
...
uint64_t HELPER(float_cvtpw_ps)(uint64_t fdt0)
{
    uint32_t wt2;
    uint32_t wth2;
...
uint32_t HELPER(float_cvts_d)(uint64_t fdt0)
{
    uint32_t fst2;
...
uint32_t HELPER(float_cvts_w)(uint32_t wt0)
{
    uint32_t fst2;
...
uint32_t HELPER(float_cvts_l)(uint64_t dt0)
{
    uint32_t fst2;
...
uint32_t HELPER(float_cvts_pl)(uint32_t wt0)
{
    uint32_t wt2;
...
uint32_t HELPER(float_cvts_pu)(uint32_t wth0)
{
    uint32_t wt2;
...
uint32_t HELPER(float_cvtw_s)(uint32_t fst0)
{
    uint32_t wt2;
...
uint32_t HELPER(float_cvtw_d)(uint64_t fdt0)
{
    uint32_t wt2;
...
uint64_t HELPER(float_roundl_d)(uint64_t fdt0)
{
    uint64_t dt2;
...
uint64_t HELPER(float_roundl_s)(uint32_t fst0)
{
    uint64_t dt2;
...
uint32_t HELPER(float_roundw_d)(uint64_t fdt0)
{
    uint32_t wt2;
...
uint32_t HELPER(float_roundw_s)(uint32_t fst0)
{
    uint32_t wt2;
...
uint64_t HELPER(float_truncl_d)(uint64_t fdt0)
{
    uint64_t dt2;
...
uint64_t HELPER(float_truncl_s)(uint32_t fst0)
{
    uint64_t dt2;
...
uint32_t HELPER(float_truncw_d)(uint64_t fdt0)
{
    uint32_t wt2;
...
uint32_t HELPER(float_truncw_s)(uint32_t fst0)
{
    uint32_t wt2;
...
uint64_t HELPER(float_ceill_d)(uint64_t fdt0)
{
    uint64_t dt2;
...
uint64_t HELPER(float_ceill_s)(uint32_t fst0)
{
    uint64_t dt2;
...
uint32_t HELPER(float_ceilw_d)(uint64_t fdt0)
{
    uint32_t wt2;
...
uint32_t HELPER(float_ceilw_s)(uint32_t fst0)
{
    uint32_t wt2;
...
uint64_t HELPER(float_floorl_d)(uint64_t fdt0)
{
    uint64_t dt2;
...
uint64_t HELPER(float_floorl_s)(uint32_t fst0)
{
    uint64_t dt2;
...
uint32_t HELPER(float_floorw_d)(uint64_t fdt0)
{
    uint32_t wt2;
...
uint32_t HELPER(float_floorw_s)(uint32_t fst0)
{
    uint32_t wt2;
...
uint64_t HELPER(float_ ## name ## _d)(uint64_t fdt0)                \
{                                                              \
    return float64_ ## name(fdt0);                             \
}                                                              \
uint32_t HELPER(float_ ## name ## _s)(uint32_t fst0)                \
{                                                              \
    return float32_ ## name(fst0);                             \
}                                                              \
uint64_t HELPER(float_ ## name ## _ps)(uint64_t fdt0)               \
{                                                              \
    uint32_t wt0;                                              \
    uint32_t wth0;                                             \
                                                               \
...
uint64_t HELPER(float_recip_d)(uint64_t fdt0)
{
    uint64_t fdt2;
...
uint32_t HELPER(float_recip_s)(uint32_t fst0)
{
    uint32_t fst2;
...
uint64_t HELPER(float_rsqrt_d)(uint64_t fdt0)
{
    uint64_t fdt2;
...
uint32_t HELPER(float_rsqrt_s)(uint32_t fst0)
{
    uint32_t fst2;
...
uint64_t HELPER(float_recip1_d)(uint64_t fdt0)
{
    uint64_t fdt2;
...
uint32_t HELPER(float_recip1_s)(uint32_t fst0)
{
    uint32_t fst2;
...
uint64_t HELPER(float_recip1_ps)(uint64_t fdt0)
{
    uint32_t fst2;
    uint32_t fsth2;
...
uint64_t HELPER(float_rsqrt1_d)(uint64_t fdt0)
{
    uint64_t fdt2;
...
uint32_t HELPER(float_rsqrt1_s)(uint32_t fst0)
{
    uint32_t fst2;
...
uint64_t HELPER(float_rsqrt1_ps)(uint64_t fdt0)
{
    uint32_t fst2;
    uint32_t fsth2;
...
#define FLOAT_OP(name, p) void HELPER(float_##name##_##p)(void)

/* binary operations */
#define FLOAT_BINOP(name)                                          \
uint64_t HELPER(float_ ## name ## _d)(uint64_t fdt0, uint64_t fdt1)     \
{                                                                  \
    uint64_t dt2;                                                  \
                                                                   \
    set_float_exception_flags(0, &env->active_fpu.fp_status);            \
    ...
    return dt2;                                                    \
                                                                   ...
                                                                   \
uint32_t HELPER(float_ ## name ## _s)(uint32_t fst0, uint32_t fst1)     \
{                                                                  \
    uint32_t wt2;                                                  \
                                                                   \
    set_float_exception_flags(0, &env->active_fpu.fp_status);            \
    ...
    return wt2;                                                    \
                                                                   ...
                                                                   \
uint64_t HELPER(float_ ## name ## _ps)(uint64_t fdt0, uint64_t fdt1)    \
{                                                                  \
...
uint64_t HELPER(float_ ## name1 ## name2 ## _d)(uint64_t fdt0, uint64_t fdt1,  \
                                           uint64_t fdt2)                 \
{                                                                         \
    ...
    return float64_ ## name2 (fdt0, fdt2, &env->active_fpu.fp_status);          \
                                                                          ...
                                                                          \
uint32_t HELPER(float_ ## name1 ## name2 ## _s)(uint32_t fst0, uint32_t fst1,  \
                                           uint32_t fst2)                 \
{                                                                         \
    ...
    return float32_ ## name2 (fst0, fst2, &env->active_fpu.fp_status);          \
                                                                          ...
                                                                          \
uint64_t HELPER(float_ ## name1 ## name2 ## _ps)(uint64_t fdt0, uint64_t fdt1, \
                                            uint64_t fdt2)                \
{                                                                         \
    uint32_t fst0 = fdt0 & 0XFFFFFFFF;                                    \
    uint32_t fsth0 = fdt0 >> 32;                                          \
...
uint64_t HELPER(float_n ## name1 ## name2 ## _d)(uint64_t fdt0, uint64_t fdt1, \
                                           uint64_t fdt2)                 \
{                                                                         \
    fdt0 = float64_ ## name1 (fdt0, fdt1, &env->active_fpu.fp_status);          \
    ...
    return float64_chs(fdt2);                                             \
                                                                          ...
                                                                          \
uint32_t HELPER(float_n ## name1 ## name2 ## _s)(uint32_t fst0, uint32_t fst1, \
                                           uint32_t fst2)                 \
{                                                                         \
    fst0 = float32_ ## name1 (fst0, fst1, &env->active_fpu.fp_status);          \
    fst2 = float32_ ## name2 (fst0, fst2, &env->active_fpu.fp_status);          \
    return float32_chs(fst2);                                             \
                                                                          ...
                                                                          \
uint64_t HELPER(float_n ## name1 ## name2 ## _ps)(uint64_t fdt0, uint64_t fdt1,\
                                           uint64_t fdt2)                 \
{                                                                         \
    uint32_t fst0 = fdt0 & 0XFFFFFFFF;                                    \
    uint32_t fsth0 = fdt0 >> 32;                                          \
...
uint64_t HELPER(float_recip2_d)(uint64_t fdt0, uint64_t fdt2)
{
    set_float_exception_flags(0, &env->active_fpu.fp_status);
...
uint32_t HELPER(float_recip2_s)(uint32_t fst0, uint32_t fst2)
{
    set_float_exception_flags(0, &env->active_fpu.fp_status);
...
uint64_t HELPER(float_recip2_ps)(uint64_t fdt0, uint64_t fdt2)
{
    uint32_t fst0 = fdt0 & 0XFFFFFFFF;
    uint32_t fsth0 = fdt0 >> 32;
    uint32_t fst2 = fdt2 & 0XFFFFFFFF;
...
uint64_t HELPER(float_rsqrt2_d)(uint64_t fdt0, uint64_t fdt2)
{
    set_float_exception_flags(0, &env->active_fpu.fp_status);
    fdt2 = float64_mul(fdt0, fdt2, &env->active_fpu.fp_status);
...
uint32_t HELPER(float_rsqrt2_s)(uint32_t fst0, uint32_t fst2)
{
    set_float_exception_flags(0, &env->active_fpu.fp_status);
    fst2 = float32_mul(fst0, fst2, &env->active_fpu.fp_status);
...
uint64_t HELPER(float_rsqrt2_ps)(uint64_t fdt0, uint64_t fdt2)
{
    uint32_t fst0 = fdt0 & 0XFFFFFFFF;
    uint32_t fsth0 = fdt0 >> 32;
    uint32_t fst2 = fdt2 & 0XFFFFFFFF;
...
uint64_t HELPER(float_addr_ps)(uint64_t fdt0, uint64_t fdt1)
{
    uint32_t fst0 = fdt0 & 0XFFFFFFFF;
    uint32_t fsth0 = fdt0 >> 32;
    uint32_t fst1 = fdt1 & 0XFFFFFFFF;
...
uint64_t HELPER(float_mulr_ps)(uint64_t fdt0, uint64_t fdt1)
{
    uint32_t fst0 = fdt0 & 0XFFFFFFFF;
    uint32_t fsth0 = fdt0 >> 32;
    uint32_t fst1 = fdt1 & 0XFFFFFFFF;
...
void HELPER(cmp_d_ ## op )(uint64_t fdt0, uint64_t fdt1, int cc)    \
{                                                              \
    int c = cond;                                              \
    update_fcr31();                                            \
    if (c)                                                     \
...
void HELPER(cmpabs_d_ ## op )(uint64_t fdt0, uint64_t fdt1, int cc) \
{                                                              \
    int c;                                                     \
...
void HELPER(cmp_s_ ## op )(uint32_t fst0, uint32_t fst1, int cc)    \
{                                                              \
    int c = cond;                                              \
    update_fcr31();                                            \
    if (c)                                                     \
...
void HELPER(cmpabs_s_ ## op )(uint32_t fst0, uint32_t fst1, int cc) \
{                                                              \
    int c;                                                     \
...
void HELPER(cmp_ps_ ## op )(uint64_t fdt0, uint64_t fdt1, int cc)    \
{                                                               \
...
void HELPER(cmpabs_ps_ ## op )(uint64_t fdt0, uint64_t fdt1, int cc) \
{                                                               \
    uint32_t fst0 = float32_abs(fdt0 & 0XFFFFFFFF);             \
    uint32_t fsth0 = float32_abs(fdt0 >> 32);                   \
    uint32_t fst1 = float32_abs(fdt1 & 0XFFFFFFFF);             \
